...
var Question = function (question,answers,wrightChoise) {
    this.question = question;
    this.answers = answers;
    this.wrightChoise = wrightChoise;
}
...
(
    function () {
        ...
        do{
            var answer = prompt('Enter the answer here (Hint : type only number.]');
            if (answer !== NaN && (answer >= 0 && answer <= 4) && answer !== '') {
                if ((answer - 1) === question.wrightChoise) {
